    ...
    <div className="min-h-screen bg-gradient-to-b from-[#f0e5ff] to-[#d3b3ff] py-10 px-4 flex justify-center">
      <div className="w-full max-w-3xl">
        ...
        <section className="w-full border border-gray-200 rounded-lg shadow-sm p-6">
          <h1 className="text-xl sm:text-md font-bold leading-tight mb-4">
            {post.title}
          </h1>
          ...
          <p className="text-base sm:text-xs md:text-md leading-relaxed text-gray-700 mt-4 break-words whitespace-pre-wrap">
            {post.content}
          </p>
